...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Mindscape Vaults is a puzzle-adventure game set in a digital dream world with a rich narrative." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Mindscape Vaults is a puzzle-adventure game set in a digital dream world with a rich narrative." },
